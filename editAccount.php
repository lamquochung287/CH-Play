        ...
        <table class="table table-borderless">
            <tr>
                ...
                <td class="w-50 pt-0"><p name="txtUsername"><?php
                        echo $username; 
                    ?></p></td><!--Display username only, not change username-->
            </tr>
            <tr>
                ...
                <?php
                    echo '•';
                    ?>"></td> <!--Display password only, not change password-->
            </tr>
            <tr>
                <td class="w-25 p-0">Full name: </td>
                <td class="w-50 pt-0"><input type="text" name="txtFullname" placeholder="Change your full name: "></td>
            </tr>
            <tr>
                <td class="w-25 p-0">Email: </td>
                <td class="w-50 pt-0"><input type="text" name="txtEmail" placeholder="Change your email: "></td>
            </tr>
            <tr>
                <td></td>
                <td><button type="submit" name="Done" class="btn btn-primary">Done!</button></td>
            </tr>
        </table>
        <?php
