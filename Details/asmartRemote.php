...
<div class="container" id="appContent">
    <div class="row mr-0">
        ...
        <div class="col-lg-8 col-md-9 col- d-flex justify-content-center">
            <h2 class="title">
                ASmart Remote IR
                <br>
                <p class="d-flex justify-content-end author">NXRsoft &nbsp&nbsp Tools</p>
    ...
    <div class="row mb-5">
        <div class="col-lg-3 col-md-3 d-flex justify-content-center">
            <a >
                <img class="image-responsive appImg" src="https://play-lh.googleusercontent.com/9vV0pi2lvlD09LUhcd4P1792suowPYY9QKkE95nc9Tka3o8ECYtdWAZp5Bolcp2F7eRA=w720-h310-rw">
            </a>
        </div>
        <div class="col-lg-3 col-md-3 d-flex justify-content-center">
            <a>
                <img class="image-responsive appImg" src="https://play-lh.googleusercontent.com/D1pUkxeQvshk2rc_0kuAHcNFSzmli-jaa-PMnTSm3jJfCnmzjT9MXhmBn7wEktd-Zug=w720-h310-rw">
            </a>
        </div>
        <div class="col-lg-3 col-md-3 d-flex justify-content-center">
            <a>
                <img class="image-responsive appImg" src="https://play-lh.googleusercontent.com/hUDp9e2OFm4CQ-q44c8tJ0r6WMAUkKAdKIr5ye2mfd4NJjqiqBe7xFU2QI6zKsBAYiA=w720-h310-rw">
            </a>
        </div>
        <div class="col-lg-3 col-md-3 d-flex justify-content-center">
            <a>
                <img class="image-responsive appImg" src="https://play-lh.googleusercontent.com/7_snPooDKWRgbUPqEVtLvOZnuz6646ON3kmPa_SmK7r3QZPolw95c9xVfP8Lza2aygs=w720-h310-rw">
            </a>
        </div>
    </div>
    <div class="row mr-auto mb-3">
        <p>A Smart IR Universal Remote Control for Android.
            Smart Remote control for electronic devices with your SAMSUNG Galaxy S4, S5, Note3, Galaxy Tab / HTC ONE Smart phone with IR(Infra Red) Remote.</p>
        <p>You can use your smart phone as IR Smart Remote Control for: <br>
            TV <br>
            Settop Box <br>
            Air Conditioner <br>
            DSLR Camera <br>
            DVD/Bluray Player <br>
            Projector <br>
            Streaming Box</p>
