...
<div class="container" id="appContent">
    <div class="row mr-0">
        ...
        <div class="col-lg-8 col-md-9 col- d-flex justify-content-center">
            <h2 class="title">
                RAR
                <br>
                <p class="d-flex justify-content-end author">RARLAB &nbsp&nbsp Tools</p>
    ...
    <div class="row mb-5">
        <div class="col-lg-3 col-md-3 d-flex justify-content-center">
            <a >
                <img class="image-responsive appImg" src="https://play-lh.googleusercontent.com/R8q_gQNvjk3xy8cP2itoSTpUmlqJouPlwYxd9uiucAPqNyVsULGha0wRrf52BSNHFg=w720-h310-rw">
            </a>
        </div>
        <div class="col-lg-3 col-md-3 d-flex justify-content-center">
            <a>
                <img class="image-responsive appImg" src="https://play-lh.googleusercontent.com/25G1UN9pfyNVHJqtG4QqawbMonds4pNC--IocxFwObEEp6kXD7i0Vj-drQE63EWPdA=w720-h310-rw">
            </a>
        </div>
        <div class="col-lg-3 col-md-3 d-flex justify-content-center">
            <a>
                <img class="image-responsive appImg" src="https://play-lh.googleusercontent.com/f5xcpuHs42jMTnoAQtZaeOSpT-KerMrS1P9AmN-ZAh5ls6J9vdSgDwfFdwNScEsk-Q=w720-h310-rw">
            </a>
        </div>
        <div class="col-lg-3 col-md-3 d-flex justify-content-center">
            <a>
                <img class="image-responsive appImg" src="https://play-lh.googleusercontent.com/4MGXhdB3yGbsfE7MA6nxvi80-etLv5RooOdifJddAlp6RNyArQGxU5XzQIcwKl1Erw=w720-h310-rw">
            </a>
        </div>
    </div>
    <div class="row mr-auto mb-3">
        <p>RARLAB's RAR is an all-in-one, original, free, simple, easy and quick compression program, archiver, backup tool, extractor and even a basic file manager.</p>
        <p>RAR can create RAR and ZIP and unpack RAR, ZIP, TAR, GZ, BZ2, XZ, 7z, ISO, ARJ archives. List of functions include repair command for damaged ZIP and RAR files, benchmark function compatible with RARLAB's WinRAR benchmark, recovery record, usual and recovery volumes, encryption, solid archives, utilizing multiple CPU cores to compress data</p>
        <p>Additionally to standard ZIP files, unzip function supports ZIP and ZIPX with BZIP2, LZMA, PPMd and XZ compression also as password protected ZIP. Unrar command is available for all versions of RAR archives including the latest RAR5, password protected and multipart files.</p>
        <p>If you wish to help us translating RAR to your language, please download RAR for Android language files in "RAR extras" section of www.rarlab.com and follow instructions in readme.txt. Thank you.</p>
        <br>
    </div>
    <div class="row mr-auto mb-3">
