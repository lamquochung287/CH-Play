...
<div class="container" id="appContent">
    <div class="row mr-0">
        ...
        <div class="col-lg-8 col-md-9 col- d-flex justify-content-center">
            <h2 class="title">
                Hola VPN
                <br>
                <p class="d-flex justify-content-end author">Hola VPN Ltd &nbsp&nbsp Tools</p>
    ...
    <div class="row mb-5">
        ...
        <div class="col-lg-3 col-md-3 d-flex justify-content-center">
            <a >
                <img class="image-responsive appImg" src="https://play-lh.googleusercontent.com/diwZQtQmNOZ0rrh5QCX4sEVrLm5586_lVYN4GsETwUOA0_xv1whcZUoHrosSKo_ZtHU=w720-h310-rw">
            </a>
        </div>
        <div class="col-lg-3 col-md-3 d-flex justify-content-center">
            <a>
                <img class="image-responsive appImg" src="https://play-lh.googleusercontent.com/z1CdHKCPtL4GS913_ovvmxHEmWGB3dhJiw9z4taHl66Uogl10rToFqfvzCvFJulxgHQ=w720-h310-rw">
            </a>
        </div>
        <div class="col-lg-3 col-md-3 d-flex justify-content-center">
            <a>
                <img class="image-responsive appImg" src="https://play-lh.googleusercontent.com/5oiP-O7Jx3MXUH_dNkL83naSXyVABxZTHXZ--38uEjFsK5v7Cj2kAgLzqyKlocDEyQ=w720-h310-rw">
            </a>
        </div>

    </div>
    <div class="row mr-auto mb-3">
        <b><p>Unlimited VPN Plus | Unblock websites, apps, and content | Keep your activities safe, secure and private.</p></b>
        ...
        <p>Hola VPN Plus contains Lightning Browser and is used under Lightning Browser Mozilla Public Licence, Version 2.0. A copy of this license is available at: https://github.com/anthonycr/Lightning-Browse</p>
        <br>
    </div>
    <div class="row mr-auto mb-3">
