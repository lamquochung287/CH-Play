...
<div class="container" id="appContent">
    <div class="row mr-0">
        <div class="col-lg-4 detailsImg mb-2 mr-0">
            <img class="image-responsive appImg" src="https://play-lh.googleusercontent.com/obYeYMv_7Tw1azkH0Q5Ejv8pasbVbnqebOT4TSpJZYFlI9B8e6xXfpEXUzIMTnY7-WE=s180-rw">
        </div>
        <div class="col-lg-8 col-md-9 col- d-flex justify-content-center">
            <h2 class="title">
                Shopee No. 1 Online Platform
                <br>
                <p class="d-flex justify-content-end author">Shopee &nbsp&nbsp Shopping</p>
    ...
    <div class="row mb-5">
        <div class="col-lg-3 col-md-3 d-flex justify-content-center">
            <a >
                <img class="image-responsive appImg" src="https://play-lh.googleusercontent.com/v7xSLPhB2Rr4Eua9VdcPp8sKWydibNFyL0_ayD7mISgefOVzHQgmsTcb4kCzoPzlaCY=w720-h310-rw">
            </a>
        </div>
        <div class="col-lg-3 col-md-3 d-flex justify-content-center">
            <a>
                <img class="image-responsive appImg" src="https://play-lh.googleusercontent.com/_6_3rQfAH39_RVru7YqV5lP6-dYy4v7t07ZhwFORXquDUC-LlfdZvW60UnfmzckFNK0=w720-h310-rw">
            </a>
        </div>
        <div class="col-lg-3 col-md-3 d-flex justify-content-center">
            <a>
                <img class="image-responsive appImg" src="https://play-lh.googleusercontent.com/sNzOsFDMn1yBWDlBpUYAr050pd33yk6ylNlDUUlvHcMS5UrhO_tHTocrp-XY70jTRg=w720-h310-rw">
            </a>
        </div>
        <div class="col-lg-3 col-md-3 d-flex justify-content-center">
            <a>
                <img class="image-responsive appImg" src="https://play-lh.googleusercontent.com/64e3BS2CwRN1p92LmW6sxnVywFtYCIT6g8G8zQV6EIm0I08xR2th9wsqT8ZqWMRKJII=w720-h310-rw">
            </a>
        </div>
    ...
    <div class="row mr-auto mb-3">
        <b><p>SHOP ANYTIME, ANYWHERE</p></b>
        <p>Shopee is the leading online shopping platform in Southeast Asia and Taiwan that offers convenient and seamless shopping to users that are looking to shop anytime and anywhere. With strong payment and logistical support, Shopee provides all users with an easy, secure, and fast online shopping experience.</p>
        <b><p>APP HIGHLIGHTS:  &nbsp&nbsp </p></b>
        <p>• Search by category and brand <br>
            • App-exclusive offers and daily deals notifications <br>
            • Personalised product recommendations <br>
            • Customer rating and reviews <br>
            • Shopee Coins with every purchase <br>
            • Order tracking <br>
            • 100% protection with Shopee Guarantee <br>
            • Many more to come</p>
        <br>
    </div>
    <div class="row mr-auto mb-3">
