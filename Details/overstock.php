...
<div class="container" id="appContent">
    <div class="row mr-0">
        ...
        <div class="col-lg-8 col-md-9 col- d-flex justify-content-center">
            <h2 class="title">
                Overstock
                <br>
                <p class="d-flex justify-content-end author">Overstock.com &nbsp&nbsp Shopping</p>

            </h2>
        </div>
    </div>
    <div class="row mr-auto mb-3 d-flex justify-content-center">
        <iframe class="embed-responsive-item" width="854" height="480" src="https://www.youtube.com/embed/7QLN8NQaW78" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>

    </div>
    <div class="row mb-5">
        <div class="col-lg-3 col-md-3 d-flex justify-content-center">
            <a >
                <img class="image-responsive appImg" src="https://play-lh.googleusercontent.com/2Pwf6qjOxqQmF6aPDqiBPagYE2PO0RH6b-m13zsL_RoCgykssTh7HXKGrTnMz4jFfX4=w720-h310-rw">
            </a>
        </div>
        <div class="col-lg-3 col-md-3 d-flex justify-content-center">
            <a>
                <img class="image-responsive appImg" src="https://play-lh.googleusercontent.com/crMNdXlowkBDuLRuJBLs56axcqEKhOAnY5RYb42kb9eTSNZIlK-qoaqGSIRatT4rkMWD=w720-h310-rw">
            </a>
        </div>
        <div class="col-lg-3 col-md-3 d-flex justify-content-center">
            <a>
                <img class="image-responsive appImg" src="https://play-lh.googleusercontent.com/zf0QWKvdOS-yrWl6g_mX83Cpj3jossybgtE5MqGN4oYdwjUzVpwWjbWymCfKERsSS_hj=w720-h310-rw">
            </a>
        </div>
        <div class="col-lg-3 col-md-3 d-flex justify-content-center">
            <a>
                <img class="image-responsive appImg" src="https://play-lh.googleusercontent.com/N-FIQdm_2k9auVw4ZkrXoGCC6jOnG9ak9gCwDB84Ye8OAfpBFbut39ewDRcJZN9Xmmw=w720-h310-rw">
            </a>
        </div>
    ...
    <div class="row mr-auto mb-3">
        <p>Overstock is the app to get exclusive deals on everything home. We’re talking major coupon bump-ups and deals on your favorite home brands - all available only on the Overstock app. All the things you want to improve the look of your home for less. Sign up for price alerts to shop rugs, living and dining room furniture, and garden and patio. You won’t find these home savings anywhere else on the internet. And deals drop daily right here on the Overstock app. We’ll even alert you when they do. Plus, with the Overstock app, get free shipping on EVERYTHING!*</p>
        <br>
    </div>
    <div class="row mr-auto mb-3">
