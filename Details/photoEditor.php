...
<div class="container" id="appContent">
    <div class="row mr-0">
        ...
        <div class="col-lg-8 col-md-9 col- d-flex justify-content-center">
            <h2 class="title">
                Photo Editor Pro
                <br>
                <p class="d-flex justify-content-end author">InShot Inc  &nbsp&nbsp Photography</p>
    ...
    <div class="row mb-5">
        ...
        <div class="col-lg-3 col-md-3 d-flex justify-content-center">
            <a>
                <img class="image-responsive appImg" src="https://play-lh.googleusercontent.com/w4uJdiFk-l6o_YLrTJSLiHEhH8trmRG2zxnBxYQr_vc_fNj4lwTz2k4GSJeaYCLNwTo=w720-h310-rw">
            </a>
        </div>
        <div class="col-lg-3 col-md-3 d-flex justify-content-center">
            <a>
                <img class="image-responsive appImg" src="https://play-lh.googleusercontent.com/UGilJUorevFBY_Q62pEx0LRixKtudX4-z5Ij29DSzftGK-lMHePA6xwd2C_7tiTRjV7h=w720-h310-rw">
            </a>
        </div>
        <div class="col-lg-3 col-md-3 d-flex justify-content-center">
            <a>
                <img class="image-responsive appImg" src="https://play-lh.googleusercontent.com/ROSGfd-WBruvtOgbb8cflyVhVhOOpThghuv4ydDXc0OerVYqhX8W87hhU5EEvr9axAA=w720-h310-rw">
            </a>
        </div>
    ...
    <div class="row mr-auto mb-3">
        ...
        <p>👓60+ Filters for Pictures <br>
            - Lomo, PINK, Vignette, Natural, Warm, Dew, Dark, Cocoa... <br>
            - Adjust brightness, contrast, saturation, hue, warmth etc.</p>
        <p class="w-100">✨Glitch Effects & Blur Background <br>
            - GB, RG, Neon, Negative, Swirl, Pixel, Fisheye and more; <br>
            - Blur photo background to get <b>DSLR Blur Effect.</b></p>
        <p>👑Photo Blender & Light FX <br>
            - Mix and blend two images to make stunning artworks; <br>
