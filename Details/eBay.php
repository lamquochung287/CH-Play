...
<div class="container" id="appContent">
    <div class="row mr-0">
        ...
        <div class="col-lg-8 col-md-9 col- d-flex justify-content-center">
            <h2 class="title">
                eBay
                <br>
                <p class="d-flex justify-content-end author">eBay Mobile &nbsp&nbsp Shopping</p>
    ...
    <div class="row mb-5">
        <div class="col-lg-3 col-md-3 d-flex justify-content-center">
            <a >
                <img class="image-responsive appImg" src="https://play-lh.googleusercontent.com/OAJ1t2KjF2km-oK57e-41S_pePbB144A5rPIcrLZcCBuwH7QE_nwmDi1KjRqkCS2Mwta=w720-h310-rw">
            </a>
        </div>
        <div class="col-lg-3 col-md-3 d-flex justify-content-center">
            <a>
                <img class="image-responsive appImg" src="https://play-lh.googleusercontent.com/l1MsWPwaQE_fZtj9jCt6ScwRRJ-SQD54y7w14e4AJ_kGQEGJzZ8GALyI8ihBpFBYJ2M=w720-h310-rw">
            </a>
        </div>
        <div class="col-lg-3 col-md-3 d-flex justify-content-center">
            <a>
                <img class="image-responsive appImg" src="https://play-lh.googleusercontent.com/b8cVcn5-_iPkW6zXteviaAwLS-fYkQSdcECB3GsZDJcHcEZN5gJo4UX7BORHnUgDNAM=w720-h310-rw">
            </a>
        </div>
        <div class="col-lg-3 col-md-3 d-flex justify-content-center">
            <a>
                <img class="image-responsive appImg" src="https://play-lh.googleusercontent.com/T3jzGgwDYbRM9E15hHfJaUhUALtwh6LZCzjjProuBps8a-W2L-tNEvBvgc1a5dWeuQ4=w720-h310-rw">
            </a>
        </div>
    ...
    <div class="row mr-auto mb-3">
        <b><p>Discover great deals and sell items online</p></b>
        <b><p>Buying and selling - make the eBay shopping app work for you:</p></b>
        <p>• Get app-exclusive offers and discover online shopping deals. <br>
            • Quickly and safely speed through checkout. <br>
            • Track your online shopping orders in real-time. <br>
            • List items you want to sell in just a few minutes. <br>
            • Easily message buyers. <br>
            • Your eBay, your way: personalize your settings with features like Dark Mode, custom notifications, and much more.</p>
        <b><p>Discover deals in every category: fashion, home and garden, trading cards, and more...</p></b>
        <br>
    </div>
    <div class="row mr-auto mb-3">
