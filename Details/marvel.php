    ...
    <div class="row mr-0">
        ...
        <div class="col-lg-8 col-md-9 col- d-flex justify-content-center">
            <h2 class="title">
                Marvel Strike Force
                <br>
                <p class="d-flex justify-content-end author">Scopely &nbsp&nbsp Role Playing</p>

            </h2>
        </div>
    </div>
    <div class="row mr-auto mb-3 d-flex justify-content-center">
        <iframe class="embed-responsive-item" width="854" height="480" src="https://www.youtube.com/embed/0AjrjXxyQ2o" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
    </div>
        <div class="row mb-3">
        <div class=" col-lg-6 col-md-12  col- d-flex justify-content-center">
            <a >
                <img class="image-responsive appImg" src="https://play-lh.googleusercontent.com/eh5DVMA2qul31qBsmEyZbTTQYRrmKSBVUGmdKr-uvCee3ggFN3y5Kct_bPAUrSiqZQ=w720-h310-rw">
            </a>
        </div>
        <div class=" col-lg-6 col-md-12 col- d-flex justify-content-center">
            <a>
                <img class="image-responsive appImg" src="https://play-lh.googleusercontent.com/nCH5KSrw9prmG7Y27Tl4gMzxy20hOhiO-ypG5hUb8QKReIO7AxgLMofCTA3X-GVgsB8=w720-h310-rw">
            </a>
        </div>

    </div>
    <div class="row mr-auto mb-3">
        <p>In <b>MARVEL Strike Force</b>, ready for battle alongside allies and arch-rivals in this action-packed, visually-stunning free-to-play game for your phone or tablet. An assault on Earth has begun and Super Heroes and Super Villains are working together to defend it! Lead the charge by assembling your ultimate squad of MARVEL characters, including Doctor Strange, Loki, Venom, Spider-Man, Captain America, Iron Man, and more.</p>
        <b class="w-100">ASSEMBLE YOUR SQUAD</b>
        <p>Recruit your strike force and form a squad of powerful MARVEL Super Heroes and Super Villains in a fight to save the universe.</p>
        <b>STRENGTH THROUGH EVOLUTION</b>
        <p class="w-100">Outfit and upgrade your Super Heroes and Super Villains to become stronger than ever before.</p>
        <b>STRATEGIC DOMINATION</b>
        <p>Who you bring to the fight matters. Pair up specific Super Heroes and Super Villains to perform combo moves to take out enemies. Expert in-fight tactics in 5v5 battles give you the power to vanquish the greatest villains of the Marvel Universe.</p>
        <b class="w-100">EPIC COMBAT</b>
        <p>Experience groundbreaking gameplay cinematics, as your heroes unleash dynamic chain combos with a single tap.</p>
        <br>
    </div>
    <div class="row mr-auto mb-3">
