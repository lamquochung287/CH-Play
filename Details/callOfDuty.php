    ...
    <div class="row mr-0">
        ...
        <div class="col-lg-8 col-md-9 col- d-flex justify-content-center">
            <h2 class="title">
                Call Of Duty
                <br>
                <p class="d-flex justify-content-end author">Activision Publishing, Inc &nbsp&nbsp Action</p>

            </h2>
        </div>
    </div>
    <div class="row mr-auto mb-3 d-flex justify-content-center">
        <iframe  class="embed-responsive-item" width="854" height="480" src="https://www.youtube.com/embed/gFKhZToY-LM" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
    </div>
        <div class="row mb-3">
            <div class=" col-lg-6 col-md-12  col- d-flex justify-content-center">
                <a >
                    <img class="image-responsive appImg" src="https://play-lh.googleusercontent.com/k0JLJS4zQIXOpe3zfrARxXiCr_qH7nsa5LdCr5sB_cwsRNW0sGCwh8UR_Z9bgdQ4Vls=w720-h310-rw">
                </a>
            </div>
            <div class=" col-lg-6 col-md-12 col- d-flex justify-content-center">
                <a>
                    <img class="image-responsive appImg" src="https://play-lh.googleusercontent.com/GFA4YkjaFrDiWWdbOync92r163x-QMB3FGaCONHmUSLRjd8cJVHCVrnD380y5US2ax8A=w720-h310-rw">
                </a>
            </div>
        ...
        <div class="row mr-auto mb-3">
            ...
            <b>BELOVED GAME MODES AND MAPS</b>
            ...
            <b>CUSTOMIZE YOUR UNIQUE LOADOUT</b>
