...
<div class="container" id="appContent">
    ...
    <div class="row mb-5">
        <div class="col-lg-3 col-md-3 d-flex justify-content-center">
            <a >
                <img class="image-responsive appImg" src="https://play-lh.googleusercontent.com/uG9NUaNltBdpucu2AEblXcnE4qhooyEF1l1sQdxgTbqoPB0m_s3iCyvvu4oeVkVq1w=w720-h310-rw">
            </a>
        </div>
        <div class="col-lg-3 col-md-3 d-flex justify-content-center">
            <a>
                <img class="image-responsive appImg" src="https://play-lh.googleusercontent.com/ok7iHYZWv7NqUf5rRo6hHupgkRZHxy0BGfB3dFHlOJeCijGpOYYssRo0t4KD88A5Mow=w720-h310-rw">
            </a>
        </div>
        <div class="col-lg-3 col-md-3 d-flex justify-content-center">
            <a>
                <img class="image-responsive appImg" src="https://play-lh.googleusercontent.com/u3iYYwR_pgaRm-DGdKYD-G80A3Vn_BOa68Y8qiZrmJL3mZJY_rc0F6G4NjztD_xmAQ=w720-h310-rw">
            </a>
        </div>
        <div class="col-lg-3 col-md-3 d-flex justify-content-center">
            <a>
                <img class="image-responsive appImg" src="https://play-lh.googleusercontent.com/OPexnVHHefcukMve7HXK8Oud3KYsx0v1l5u99svvj1PvD5jNQOsztSVWgK81QLjJ94U=w720-h310-rw">
            </a>
        </div>
    ...
    <div class="row mr-auto mb-3">
        <p>The selfie camera that everyone's been waiting for. <br>
            Introducing Soda, the easy and effortless beauty camera.</p>
        <p class="w-100">• The perfect combination of filters and makeup <br>
            Don't worry any more about which makeup and filter to use. <br>
            Capture the most trendy styles with just one touch.</p>
        <p> • A diverse selection of color filters optimized for selfies <br>
            Try out the filters that best suit your skin! <br>
            Capture an array of different moods using various selfie filters.</p>
        <br>
    </div>
    <div class="row mr-auto mb-3">
