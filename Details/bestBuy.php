...
<div class="container" id="appContent">
    <div class="row mr-0">
        ...
        <div class="col-lg-8 col-md-9 col- d-flex justify-content-center">
            <h2 class="title">
                Best Buy
                <br>
                <p class="d-flex justify-content-end author">Best Buy &nbsp&nbsp Shopping</p>
            </h2>
        </div>
    </div>
    ...
    <div class="row mb-5">
        <div class="col-lg-3 col-md-3 d-flex justify-content-center">
            <a >
                <img class="image-responsive appImg" src="https://play-lh.googleusercontent.com/LTab93_jXZRQmWl6RVdckgZWqqAy_w70-Ha8IUNypbfKZ5Lt66DUS6nt45hlfNsTlR4=w720-h310-rw">
            </a>
        </div>
        <div class="col-lg-3 col-md-3 d-flex justify-content-center">
            <a>
                <img class="image-responsive appImg" src="https://play-lh.googleusercontent.com/6n1H6hLwJJHjPN-12BspcYhBQQXWtV0bwN0FDqmK50IavX4dqmpQfbEj0jfXVtgXhg=w720-h310-rw">
            </a>
        </div>
        <div class="col-lg-3 col-md-3 d-flex justify-content-center">
            <a>
                <img class="image-responsive appImg" src="https://play-lh.googleusercontent.com/W2EMAcSXXFyp_UKIhigyTzCF6E09I1LEY0ZgGxnma8GQQSKJK7p0RQXUB9Zpv5JEPcA=w720-h310-rw">
            </a>
        </div>
        <div class="col-lg-3 col-md-3 d-flex justify-content-center">
            <a>
                <img class="image-responsive appImg" src="https://play-lh.googleusercontent.com/2R7ITjqmToyerat9syhZgJ5ztWpoRo36NQososyUb6_-7InseQQsZNQefOz8kje0aNo=w720-h310-rw">
            </a>
        </div>
    ...
    <div class="row mr-auto mb-3">
        <p>Now the Best Buy app is more than just great hand-held shopping. <br>
            It’s your fast, feel-good companion that can help you have more convenient and possibly even cooler Best Buy experiences, whether you’re at home, on your way to pick up, or shopping with us in-store.</p>
        <p><b>Ready when you are.</b> Whether you want to pick up in store or have your order delivered to your car, use the app to let us know you’re on the way, and we’ll have it ready. <br>

            <b>Imagine the possibilities. </b>Use the AR feature to imagine the perfect TV for your home theater. <br>

            <b>We’ve got tech surprises in all sizes.</b> View ratings and 5-star reviews as you browse our huge selection of today’s top tech and toys. <br>
            <b>Get all the details.</b> Browse products available now at stores near you. Track orders and deliveries. Scan and shop. Also find nearby service options and store details - including popular times to shop.</p>
