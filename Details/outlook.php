...
<div class="container" id="appContent">
    ...
    <div class="row mb-5">
        <div class="col-lg-3 col-md-3 d-flex justify-content-center">
            <a >
                <img class="image-responsive appImg" src="https://play-lh.googleusercontent.com/is2USydTywlb6E_9CiPtMH3rXLBqsTGVS6mKLdds_SYrF6wsmoXTlduM46bW-glRmck=w720-h310-rw">
            </a>
        </div>
        <div class="col-lg-3 col-md-3 d-flex justify-content-center">
            <a>
                <img class="image-responsive appImg" src="https://play-lh.googleusercontent.com/AcTs1KWRbovRem_hJTRuKoVCSCIPnLAjlRcas71PZwL9-WT0vUTgz3SvtSMF0j8iyNs=w720-h310-rw">
            </a>
        </div>
        <div class="col-lg-3 col-md-3 d-flex justify-content-center">
            <a>
                <img class="image-responsive appImg" src="https://play-lh.googleusercontent.com/E0UEBgtmaPajoBcHKsDmXVZZsLWRA72BuGFIpnsvS7mPMqS6npm2cmJLeiBwC_lo5w=w720-h310-rw">
            </a>
        </div>
        <div class="col-lg-3 col-md-3 d-flex justify-content-center">
            <a>
                <img class="image-responsive appImg" src="https://play-lh.googleusercontent.com/3ORWXzSrhjKeJVRvlVUufUDUg6nhWHr45RGn4ywJptOqz1K56G6xHWpSH4GRiDdZrw=w720-h310-rw">
            </a>
        </div>
    </div>
    <div class="row mr-auto mb-3">
        <p>Microsoft Outlook keeps you connected and protected, with your email, calendar and files all in one app. With intelligent email, calendar reminders and contacts, Outlook for Android lets you do more from one powerful inbox. Connect. Organize. Get things done.</p>
        <p>Email friends, family and colleagues from multiple accounts on one app and see what matters most first with the Focused Inbox that keeps the important messages on top. Switch between your emails and calendar to schedule your next meeting or share your availability with anyone with just a few taps. Email a document from your Files list or a photo from your Gallery and attach it easily.
        </p>
        <p>Microsoft Outlook provides secure and seamless inbox management that enables you to stay connected on the go. Outlook includes Office, Word, Excel, PowerPoint and OneDrive integrations to help you manage and send files and connects with Teams, Zoom and other video calling providers without hassle.
        </p>
        <p>Customize email and calendars so you can stay on top of your busy day. Listen to what’s new in your inbox, organize schedules and more. Find what you need with Search- it’s only a tap away or you can use your voice and ask for what you need with language you use every day.</p>
        <br>
    </div>
    <div class="row mr-auto mb-3">
