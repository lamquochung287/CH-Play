...
<div class="container" id="appContent">
    <div class="row mr-0">
        ...
        <div class="col-lg-8 col-md-9 col- d-flex justify-content-center">
            <h2 class="title">
                Dots & Co
                <br>
                <p class="d-flex justify-content-end author">PlayDots &nbsp&nbsp Puzzle</p>
    ...
    <div class="row mb-3">
        <div class=" col-md-3 col-sm-6 col-">
            <a >
                <img class="image-responsive appImg" src="https://play-lh.googleusercontent.com/UDGjyUtFSil3xAkbr12jw6QMoRdn7rmobQci7nBS_RigZFc1yq8coUKsS-uHjHu5kF2H=w720-h310-rw">
            </a>
        </div>
        <div class=" col-md-3 col-sm-6 col-">
            <a>
                <img class="image-responsive appImg" src="https://play-lh.googleusercontent.com/g4sGZJaVjaBtqS7WzLj4D-tcHmSKEOcGHZXHB5fuHPu0F4rCNzwe6P-KSVyXz9Ei1Z3b=w720-h310-rw">
            </a>
        </div>
        <div class=" col-md-3 col-sm-6 col-">
            <a>
                <img class="image-responsive appImg" src="https://play-lh.googleusercontent.com/89e-yDRYjjOdsCPwtuAdqNZt_KMxMjLT6NWQLxS6kE3khskcDeQ5KXG7NGEdzfo-5UN-=w720-h310-rw">
            </a>
        </div>
        <div class=" col-md-3 col-sm-6 col-">
            <a>
                <img class="image-responsive appImg" src="https://play-lh.googleusercontent.com/JoTD8qxruh48s7iJePNqt5HUuCpDuGmxMUmGPmtvmXXqACAAQdt0lE4hIxJXO6VlCg=w720-h310-rw">
            </a>
        </div>
    </div>
    <div class="row mr-auto mb-3">
        <p>Explore beautiful landscapes and embark on a visual journey by solving puzzles with magical companions that help you along the way.</p>
        <p>• FREE to play!
            • CHALLENGE yourself with 320 NEW and completely original levels, fun for Dots loyalists and new players alike <br>
            • ENJOY simple, thoughtful gameplay where you connect one Dot to another and play at your pace <br>
            • MEET various original Companion characters that help you beat levels <br>
            • SOLVE clever puzzles containing over 15 visual mechanics using your wits to figure out the perfect move <br>
            • TRAVEL through beautiful landscapes and get lost in the world of Dots & Co <br>
            • PLAY beautifully</p>
        <br>
    </div>
    <div class="row mr-auto mb-3">
