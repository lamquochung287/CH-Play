...
<head>
    <meta charset="UTF-8">
    <title>FaceArt Selfie Camera</title>
...
<div class="container" id="appContent">
    <div class="row mr-0">
        ...
        <div class="col-lg-8 col-md-9 col- d-flex justify-content-center">
            <h2 class="title">
                VSCO
                <br>
                <p class="d-flex justify-content-end author">VSCO &nbsp&nbsp Photography</p>

            </h2>
        </div>
    </div>
    <div class="row mr-auto mb-3 d-flex justify-content-center">
        <iframe class="embed-responsive-item" width="854" height="480" src="https://www.youtube.com/embed/OqI3qfa0FXg" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
    </div>
    <div class="row mb-5">
        <div class="col-lg-3 col-md-3 d-flex justify-content-center">
            <a >
                <img class="image-responsive appImg" src="https://play-lh.googleusercontent.com/HTA8h0oUR6OE7jjaw8cqLZwWWCiciRa_r5Q8s9oXy0w88Apl-sg5l4j3ybBNHkKzlA=w720-h310-rw">
            </a>
        </div>
        <div class="col-lg-3 col-md-3 d-flex justify-content-center">
            <a>
                <img class="image-responsive appImg" src="https://play-lh.googleusercontent.com/01aHV2uYZ1lFdhvbWMwGpZJu-57ExMuda9kpVHWC6mPbEF1V3aZy3BvxSbuP_Nl84NY=w720-h310-rw">
            </a>
        </div>
        <div class="col-lg-3 col-md-3 d-flex justify-content-center">
            <a>
                <img class="image-responsive appImg" src="https://play-lh.googleusercontent.com/OLndxw91HPgAXmsv5QZpp6TLTinWGQxXBxfTgXgfOPVr3a_owxcM4tJvOZyxH3arUA=w720-h310-rw">
            </a>
        </div>
        <div class="col-lg-3 col-md-3 d-flex justify-content-center">
            <a>
                <img class="image-responsive appImg" src="https://play-lh.googleusercontent.com/D2dE96GdMpPuG0jfKfIxx6R7Zd5ODwc_ILRGT5rvJH9JdZzeQVt-Ybbq-q9XDKdkuQ=w720-h310-rw">
            </a>
        </div>
    ...
    <div class="row mr-auto mb-3">
        <p>VSCO is a place where expression matters most. We offer creative photo and video editing tools, inspiration, and a place for you to be you.</p>
        <p>Share your photos and videos with #VSCO for a chance to be curated by VSCO. We can’t wait to see what you create.</p>
        <b class="w-100">FREE PHOTO EDITOR</b>
        <p>Take your photography to the next level with 10 free VSCO presets. Use editing tools like Contrast and Saturation to make your photos pop or use Grain and Fade to add texture and mimic analog film effects. Adjust or play around with your photo perspectives with Crop and Skew. Save and recreate your favorite edits with Recipes.</p>
        <b class="w-100">ADVANCED PHOTO EDITING TOOLS</b>
        <p>Join VSCO Membership to access VSCO’s complete preset library with over 200+ presets. Recreate vintage film looks by Kodak, Fuji, Agfa, and others with Film X. Use advanced photo editing tools like HSL and Split Tone. Frame your images with a touch of color using Borders.</p>
        <b class="w-100">VSCO MONTAGE</b>
        <p>Tell a video story and make a moving collage by layering videos, images, and shapes. Celebrate moments, illustrate a mood, or experiment with photos and videos you already have in your Studio. Adjust the opacity of any media layered in to create an eclectic range of customized gel colors and double exposures.</p>
        <b class="w-100">CONNECT WITH A CREATIVE COMMUNITY</b>
        <p>Explore inspiring photos, videos, and editorial in Discover. Find people you know and connect with friends already on VSCO. Try something new with weekly photo Challenges exclusive to your VSCO membership.</p>
        <br>
    </div>
    <div class="row mr-auto mb-3">
