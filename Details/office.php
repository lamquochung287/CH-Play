...
<div class="container" id="appContent">
    ...
    <div class="row mb-5">
        <div class="col-lg-3 col-md-3 d-flex justify-content-center">
            <a >
                <img class="image-responsive appImg" src="https://play-lh.googleusercontent.com/cDvFQbu-3O3NfyrNSkx9d1Ua25bYS3Ly8fCcPgdMnj5ktHh0uidRp0OiNVIb5OFB5ck=w720-h310-rw">
            </a>
        </div>
        <div class="col-lg-3 col-md-3 d-flex justify-content-center">
            <a>
                <img class="image-responsive appImg" src="https://play-lh.googleusercontent.com/h054Q_gu6miJlzLA59fyO6sgtSFlEVIa1iSgHeqUXik07F2-ppZNPUK8XjLdnIVI0PA=w720-h310-rw">
            </a>
        </div>
        <div class="col-lg-3 col-md-3 d-flex justify-content-center">
            <a>
                <img class="image-responsive appImg" src="https://play-lh.googleusercontent.com/OdIJbvIv-ScoGudXjc_tUtdaOgzKS8UhqBjTtHlwXba7m72mfqzION67SIyfh35rcaw=w720-h310-rw">
            </a>
        </div>
        <div class="col-lg-3 col-md-3 d-flex justify-content-center">
            <a>
                <img class="image-responsive appImg" src="https://play-lh.googleusercontent.com/d01_T1-Ol50r7NWeSzYYzmA5b10L0-KOijuzyZ8nhBlPaqOLsHtXXL1xvz_RrcpsA67r=w720-h310-rw">
            </a>
        </div>
    </div>
    <div class="row mr-auto mb-3">
        <p>The Office app combines the Word, Excel, and PowerPoint apps you know and rely on to create a single, multipurpose platform. Take advantage of powerful Microsoft tools on the go with the Office app, the simple solution for productivity.</p>
        <p>Scan PDF files, transform spreadsheets, or draft up documents anytime and anywhere by accessing the various Microsoft functions through your mobile device. With intelligent cloud services and trusted security, the Microsoft Office app will help maximize your productivity in both work and life.</p>
        <b class="w-100">Microsoft Office Features</b>
        <p><b>Word, Excel, and PowerPoint Combined:</b> <br>
            • Widely used tools now accessible within a single application, the go-to app for productivity. <br>
            • Store and access Word, Excel, and PowerPoint files using the cloud-based storage. <br>
            • Word documents can be created and collaborated on with others in real-time. <br>
            • Edit slides from PowerPoint or practice your presentation with Presenter Coach. <br>
            • Sheets on Excel can be created using one of the many templates available in-app..</p>
