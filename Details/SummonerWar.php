    ...
    <div class="row mr-0">
        ...
        <div class="col-lg-8 col-md-9 col- d-flex justify-content-center">
            <h2 class="title">
                Summoner War
                <br>
                <p class="d-flex justify-content-end author">Com2uS &nbsp&nbsp Role Playing</p>

            </h2>
        </div>
    </div>
    <div class="row mr-auto mb-3 d-flex justify-content-center">
        <iframe class="embed-responsive-item" width="854" height="480" src="https://www.youtube.com/embed/K2PdXrouQ1w" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>    </div>

    <div class="row mb-3">
        <div class=" col-lg-6 col-md-12  col- d-flex justify-content-center">
            <a >
                <img class="image-responsive appImg" src="https://play-lh.googleusercontent.com/zdKPzh5PT4y3acwy-Ce5huw0_-lHmc4bl_4Jg_c1ZCssTP9QNK6EAV4GiHfXZizw5w=w720-h310-rw">
            </a>
        </div>
        <div class=" col-lg-6 col-md-12 col- d-flex justify-content-center">
            <a>
                <img class="image-responsive appImg" src="https://play-lh.googleusercontent.com/OXUnztWfnLIl4KmRKYV9yAgTVc0V_7_uKEruFrpKmYoLeZuMSbsj-v9-ceRxugtB4HQz=w720-h310-rw">
            </a>
        </div>

    </div>
    <div class="row mr-auto mb-3">
        <b>An action-packed fantasy RPG with over 100 million Summoners around the world!</b>
        <p>Jump into the Sky Arena, a world under battle over the vital resource: Mana Crystals.
            Summon over 1,000 different types of monsters to compete for victory in the Sky Arena.
        </p>
        <b class="w-100">Summoners War: Sky Arena</b>
        <p>Summoners War Official Community:
            https://www.facebook.com/SummonersWarCom2us/</p>
        <b class="w-100">[Endless Fun]</b>
        ...
        <b class="w-100">[Massive Collection]</b>
        <p>Fire, Water, Wind, Light and Dark! <br>
            5 different attributes, and 1000 different monsters! <br>
            Collect as many monsters as you can and assemble the greatest team.</p>
        <b class="w-100">[Real-time Raid]</b>
        <p>Battle as a team! <br>
            A real-time battle with 3 users! <br>
            Defeat the boss with your fellow Summoners using various tactics.</p>
