    ...
    <div class="row mr-auto mb-3 d-flex justify-content-center">
        <div class="row mb-5">
            <div class="col-lg-3 col-md-3 d-flex justify-content-center">
                <a >
                    <img class="image-responsive appImg" src="https://play-lh.googleusercontent.com/CrRfRw8TPhbyqOJZ1qUscqOZf5pVYbO2I2oPnf0-8RBOUOV3PqthpLa1almaQ9ObN9GZ=w720-h310-rw">
                </a>
            </div>
            <div class="col-lg-3 col-md-3 d-flex justify-content-center">
                <a>
                    <img class="image-responsive appImg" src="https://play-lh.googleusercontent.com/AyIokkc-LC7LesYJEW5nSAJ9iiREzwdFl8tVRncgGGQuCQKTSgkgOKljTvgXt5yss30=w720-h310-rw">
                </a>
            </div>
            <div class="col-lg-3 col-md-3 d-flex justify-content-center">
                <a>
                    <img class="image-responsive appImg" src="https://play-lh.googleusercontent.com/Yos_wLCpHtTXhz8Z-un5OPhj5_EPFffhIg2pqCn1P4ODE5uBYbufJ2pUK1FTXMMs_rg=w720-h310-rw">
                </a>
            </div>
            <div class="col-lg-3 col-md-3 d-flex justify-content-center">
                <a>
                    <img class="image-responsive appImg" src="https://play-lh.googleusercontent.com/tnr9YFs0n22Lx74AeT00u85dsVndijFcvI3JcDqillbyKeb_600SWtaw35YZq0vbpnI=w720-h310-rw">
                </a>
            </div>
        ...
        <div class="row mr-auto mb-3">
            <b><p>Snapseed is a complete and professional photo editor developed by Google.</p></b>
            <p>• 29 Tools and Filters, including: Healing, Brush, Structure, HDR, Perspective (see list below) <br>

                • Opens JPG and RAW files <br>

                • Save your personal looks and apply them to new photos later <br>

                • Selective filter brush <br>

                • All styles can be tweaked with fine, precise control <br>
                • RAW Develop – open and tweak RAW DNG files; save non-destructively or export as JPG <br>

                • Tune image – adjust exposure and color automatically or manually with fine, precise control <br>

                • Details – magically brings out surface structures in images <br>

                • Crop – crop to standard sizes or freely <br>

                • Rotate – rotate by 90°, or straighten a skewed horizon <br>

                • Perspective – fix skewed lines and perfect the geometry of horizons or buildings <br>

                • White Balance – adjust the colors so that the image looks more natural <br>

                • Brush – selectively retouch exposure, saturation, brightness or warmth</p>
            <br>
        </div>
        <div class="row mr-auto mb-3">
