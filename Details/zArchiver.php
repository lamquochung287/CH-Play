...
<div class="container" id="appContent">
    <div class="row mr-0">
        ...
        <div class="col-lg-8 col-md-9 col- d-flex justify-content-center">
            <h2 class="title">
                ZArchiver
                <br>
                <p class="d-flex justify-content-end author">ZDevs &nbsp&nbsp Tools</p>
    ...
    <div class="row mb-5">
        <div class="col-lg-3 col-md-3 d-flex justify-content-center">
            <a >
                <img class="image-responsive appImg" src="https://play-lh.googleusercontent.com/gKQ-g_ftYkM5UwRn8ZHzI6pBsWmefZqk0zMyjy2ZU75empVVWLYqnwBURl39Kzlqqw=w720-h310-rw">
            </a>
        </div>
        <div class="col-lg-3 col-md-3 d-flex justify-content-center">
            <a>
                <img class="image-responsive appImg" src="https://play-lh.googleusercontent.com/hDL0GqhXUsMHOWOTIyp_56xd6If7i48fE_1KAKNMvtqWi3Ll_6kLxuKCNmd11QgaRp0=w720-h310-rw">
            </a>
        </div>
        <div class="col-lg-3 col-md-3 d-flex justify-content-center">
            <a>
                <img class="image-responsive appImg" src="https://play-lh.googleusercontent.com/4DfYsNDFO_J--oaH8Epmb2SIcdovfOyfvlZ2SgwktKlICEPLHi21bD-v0MWzDmDq5FY=w720-h310-rw">
            </a>
        </div>
        <div class="col-lg-3 col-md-3 d-flex justify-content-center">
            <a>
                <img class="image-responsive appImg" src="https://play-lh.googleusercontent.com/7a1qe0Wvc-hhXMFc17kRiU2FsnUpEdaTn_qrVVa0ThrYtM1s3aLltgm7-Vl5L2Q_dTc=w720-h310-rw">
            </a>
        </div>
    </div>
    <div class="row mr-auto mb-3">
        <p>ZArchiver - is a program for archive management. It has a simple and functional interface. The app doesn't have permission to access the internet, so cannot transmit any information to other services or persons.</p>
        <p> <b>ZArchiver lets you: </b> <br>

            - <b>Create the following archive types: </b>7z (7zip), zip, bzip2 (bz2), gzip (gz), XZ, lz4, tar, zst (zstd); <br>
            - <b>Decompress the following archive types:</b> 7z (7zip), zip, rar, rar5, bzip2, gzip, XZ, iso, tar, arj, cab, lzh, lha, lzma, xar, tgz, tbz, Z, deb, rpm, zipx, mtz, chm, dmg, cpio, cramfs, img (fat, ntfs, ubf), wim, ecm, lzip, zst (zstd), egg, alz; <br>
            - <b>View archive contents:</b> 7z (7zip), zip, rar, rar5, bzip2, gzip, XZ, iso, tar, arj, cab, lzh, lha, lzma, xar, tgz, tbz, Z, deb, rpm, zipx, mtz, chm, dmg, cpio, cramfs, img (fat, ntfs, ubf), wim, ecm, lzip, zst (zstd), egg, alz; <br>
            - <b>Create and decompress</b> password-protected archives; <br>
            - <b>Edit archives</b>: add/remove files to/from the archive (zip, 7zip, tar, apk, mtz); <br>
            - <b>Create and decompress multi-part archives:</b> 7z, rar(decompress only); <br>
            - <b>Partial</b> archive decompression; <br>
            - <b>Open</b> compressed files; <br>
            - <b>Open</b> an archive file from mail applications; <br>
            - <b>Extract split archives:</b> 7z, zip and rar (7z.001, zip.001, part1.rar, z01);</p>
        <br>
    </div>
    <div class="row mr-auto mb-3">
