...
<div class="container" id="appContent">
    <div class="row mr-0">
        ...
        <div class="col-lg-8 col-md-9 col- d-flex justify-content-center">
            <h2 class="title">
                Microsoft Word
                <br>
                <p class="d-flex justify-content-end author">Microsoft Corporation &nbsp&nbsp Productivity</p>
    ...
    <div class="row mb-5">
        <div class="col-lg-3 col-md-3 d-flex justify-content-center">
            <a >
                <img class="image-responsive appImg" src="https://play-lh.googleusercontent.com/lM0Cd510Na9AxqDHoWFUNa90mupHcmYaIYpKQm2cN8EKdk7elnpYQH01PV02vhIN4_8=w720-h310-rw">
            </a>
        </div>
        <div class="col-lg-3 col-md-3 d-flex justify-content-center">
            <a>
                <img class="image-responsive appImg" src="https://play-lh.googleusercontent.com/yQMKZUN5eF1aUpyTxHGlmzcfyDXW-zxhic2KoRFhDF6McbFPXv5xRWGxFxijf17Ngiwv=w720-h310-rw">
            </a>
        </div>
        <div class="col-lg-3 col-md-3 d-flex justify-content-center">
            <a>
                <img class="image-responsive appImg" src="https://play-lh.googleusercontent.com/441x1C3R9EvLxe4mFMZpeXB3xEGtUB8pB1CV5iRLWJmQ9vNktLA99vZLRKQzkNI2bwk=w720-h310-rw">
            </a>
        </div>
        <div class="col-lg-3 col-md-3 d-flex justify-content-center">
            <a>
                <img class="image-responsive appImg" src="https://play-lh.googleusercontent.com/t-HjgnTGzhmZ5Ybo7c0GMly4Ejy0viMPqE7iAQtymuH2NPA_9lxJx8IxLheYfiacYxc=w720-h310-rw">
            </a>
        </div>
    </div>
    <div class="row mr-auto mb-3">
        <p>Edit your blog posts, write essays for class, share your resume. Microsoft Word allows your writing to shine, while on the go.</p>
        <p>Writing and collaborating with your team doesn't have to be confined to the office. Edit docs and collaborate on shared projects in real time on your mobile device with the help of Microsoft Word. Documents have never been easier to create, read, edit, and share. DOCX files, PDFs and everything else — regardless of the format.</p>
        <p>Access files and make edits with ease while using the Word app. Read documents and open attachments with the built-in docs viewer or edit a PDF with the help of Word’s file conversion. Once you’re done editing, share the file in the format you’d like. Create documents and more on the go and allow Microsoft to polish them off for you with expert editing tools.</p>
        <p>Resume templates, newsletters, brochures and more are all accessible within the template gallery, simply select the documents you would like and get started.</p>
        <p><b>Create Documents</b> <br>
            • Create docs, assignments, letters, blogs, scripts, notes, resumes and more with beautifully designed modern templates. <br>
            • Editing with rich formatting and layout. <br>
            • Document editor keeps formats and layouts looking great. <br>
            • Docs app with templates for resumes, forms and more.</p>
        <p> <b>Read, Write, and Edit </b> <br>
            • Read docs, letters, PDFs, scripts, and more on your device with Reading View.  <br>
            • Edit documents from PDFs by converting to and from Word documents. <br>
            • PDF file conversion: save as PDF after editing and share your PDF file easily.</p>
