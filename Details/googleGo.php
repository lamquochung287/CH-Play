...
<div class="container" id="appContent">
    <div class="row mr-0">
        ...
        <div class="col-lg-8 col-md-9 col- d-flex justify-content-center">
            <h2 class="title">
                Google Go
                <br>
                <p class="d-flex justify-content-end author">Google Go &nbsp&nbsp Tools</p>
    ...
    <div class="row mb-5">
        <div class="col-lg-3 col-md-3 d-flex justify-content-center">
            <a >
                <img class="image-responsive appImg" src="https://play-lh.googleusercontent.com/FQiHBDq-GuVGbZ_8XZezhyXqeGIhmlHMuvRUBgtUNkdz9O8-DBLVpYhcIaJxRqSeYRA=w720-h310-rw">
            </a>
        </div>
        <div class="col-lg-3 col-md-3 d-flex justify-content-center">
            <a>
                <img class="image-responsive appImg" src="https://play-lh.googleusercontent.com/1xQ55nUV5VixW3_QtVqDmQ-nQlR_PlwjXFr_zMr01C_iJ1encKqjxk7u1dKutpd0flc=w720-h310-rw">
            </a>
        </div>
        <div class="col-lg-3 col-md-3 d-flex justify-content-center">
            <a>
                <img class="image-responsive appImg" src="https://play-lh.googleusercontent.com/c1a8OenU65aWa161SkgdqjQAjqDooWdG79GSNaUeFpl0mdD1nf6GgMqokWVv3vm0Agg=w720-h310-rw">
            </a>
        </div>
        <div class="col-lg-3 col-md-3 d-flex justify-content-center">
            <a>
                <img class="image-responsive appImg" src="https://play-lh.googleusercontent.com/KSvY8kmcbvjzusydiA-IAVZhF7dUQxJcL__aIf_H6OUKtWb1bU7KLzKSuUrlIFp1Bw=w720-h310-rw">
            </a>
        </div>
    </div>
    <div class="row mr-auto mb-3">
        <b><p>Google Go is a lighter, faster way to search, with search results optimised to save up to 40% data.</p></b>
        <p>Get answers quickly and reliably with Google Go, even on slow connections and smartphones with low space. At 7MB in size, it’s fast to download and saves space on your phone.</p>
        <p><b>Type less, discover more. </b>Save time by tapping your way through trending queries and topics, or by using your voice to say what you’re looking for.</p>
        <p><b>Search and translate with your camera.</b>See a word you don’t understand on a sign, form, or product? With Google Lens, just point your camera to translate or search for it.</p>
        <br>
    </div>
    <div class="row mr-auto mb-3">
