    ...
    <div class="row mr-0">
        ...
        <div class="col-lg-8 col-md-9 col- d-flex justify-content-center">
            <h2 class="title">
                Among Us
                <br>
                <p class="d-flex justify-content-end author">Innersloth LLC &nbsp&nbsp Action</p>
    ...
    <div class="row mr-auto mb-3 d-flex justify-content-center">
        <div class="col-lg-8 col-md-10 col-sm-4 col-">
            <div class="embed-responsive embed-responsive-16by9">
                <iframe class="embed-responsive-item" width="1280" height="720" src="https://www.youtube.com/embed/sYvKjZKunyo" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            </div>
        </div>
    </div>
    <div class="row mb-3">
        <div class="col-lg-6 col-md-12 d-flex justify-content-center">
            <a >
                <img class="image-responsive appImg" src="https://play-lh.googleusercontent.com/bFKj2NnfSECa6Fwl3U8Z6OqtJvJ1QEw44gJEo3JILoxfA-7MUb7Dn2DHOGursFSAaJoy=w720-h310-rw">
            </a>
        </div>
        <div class="col-lg-6 col-md-12 d-flex justify-content-center">
            <a>
                <img class="image-responsive appImg" src="https://play-lh.googleusercontent.com/PeOr_KZtyG--Xgrgaah1OOY22guLX7cCexRtoobCPMLXtyH92xeKkx4uA7zwQwHKyNc=w720-h310-rw">
            </a>
        </div>

    </div>
    <div class="row mr-auto mb-3">
        <b><p>Play online or over local WiFi with 4-10 players as you attempt to prep your spaceship for departure, but beware as one will be an impostor bent on killing everyone!</p></b>
        <p>Crewmates can win by completing all tasks or discovering and voting the impostor off the ship.</p>
        <br>
        <p>The Impostor can use sabotage to cause chaos, making for easier kills and better alibis.</p>
        <br>
    </div>
