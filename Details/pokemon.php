    ...
    <div class="row mr-auto mb-3 d-flex justify-content-center">
        <div class="col-lg-8 col-md-10 col-sm-4 col-">
            <div class="embed-responsive embed-responsive-16by9">
                <iframe class="embed-responsive-item" width="854" height="480" src="https://www.youtube.com/embed/DFXbVBFPOOs" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>            </div>
        </div>
    </div>
    <div class="row mb-3">
        <div class="col-lg-2 col-md-4 col-sm-6 col-">
            <a >
                <img class="image-responsive appImg" src="https://play-lh.googleusercontent.com/fhT7X9ZDXOkXk48qiDzndEhijkzD72BDYaQ0_pjdGxIaNBmW7XF97d6zsRXuFH_zb1H3=w720-h310-rw">
            </a>
        </div>
        <div class="col-lg-2 col-md-4 col-sm-6 col-">
            <a>
                <img class="image-responsive appImg" src="https://play-lh.googleusercontent.com/U4Q3f1JTyn2nB78lYBHdOmza_6s0XS2Ywb8nTiWJJrcNDIT_Q911NSt52UmgHJLBUg=w720-h310-rw">
            </a>
        </div>
        <div class="col-lg-2 col-md-4 col-sm-6 col-">
            <a>
                <img class="image-responsive appImg" src="https://play-lh.googleusercontent.com/I2yMQNf1ndHkke5hg8Fuaf_rkDjX5gJnYBYvz25ZC8dpOufunjbNbAYH0KQ2em1AMa8=w720-h310-rw">
            </a>
        </div>
        <div class="col-lg-2 col-md-4 col-sm-6 col-">
            <a>
                <img class="image-responsive appImg" src="https://play-lh.googleusercontent.com/cXM1XG3J5yXbm12OP6eZ30NHcdwMzgIHNgeOHcTO9cj1mVwnFozMqyK6X67LQAOp5Q=w720-h310-rw">
            </a>
        </div>
        <div class="col-lg-2 col-md-4 col-sm-6 col-">
            <a>
                <img class="image-responsive appImg" src="https://play-lh.googleusercontent.com/zqVVstU5aZj9k_y33LZWX7AzAfiONNXuWWN0ndbmdVEpzyidWXcj9I-G5IEN9ZZO0MUf=w720-h310-rw">
            </a>
        </div>
        <div class="col-lg-2 col-md-4 col-sm-6 col-">
            <a>
                <img class="image-responsive appImg" src="https://play-lh.googleusercontent.com/eIIOLTcs9Q_RwfRP5HH4uT0lVueKOKyLL6dm-_G_Pzwh_ck_HsaapB8UPoiG8WwC0g=w720-h310-rw">
            </a>
        </div>
    </div>
    <div class="row mr-auto mb-3">
        <b><p>NEW! Now you can battle other Pokémon GO Trainers online! Try the GO Battle League today!</p></b>
        <p>Join Trainers across the globe who are discovering Pokémon as they explore the world around them. Pokémon GO is the global gaming sensation that has been downloaded over 1 billion times and named “Best Mobile Game” by the Game Developers Choice Awards and “Best App of the Year” by TechCrunch.</p>
        <br>
        <b><p>UNCOVER THE WORLD OF POKÉMON: Explore and discover Pokémon wherever you are!</p></b>
        <b><p>JOURNEY alongside your Buddy Pokémon to help make your Pokémon stronger and earn rewards!</p></b>
        <br>
    </div>
    <div class="row mr-auto mb-3">
