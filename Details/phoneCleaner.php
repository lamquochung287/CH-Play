...
<div class="container" id="appContent">
    <div class="row mr-0">
        ...
        <div class="col-lg-8 col-md-9 col- d-flex justify-content-center">
            <h2 class="title">
                Phone Cleaner
                <br>
                <p class="d-flex justify-content-end author">Super Cleaner Studio &nbsp&nbsp Tools</p>
    ...
    <div class="row mb-5">
        <div class="col-lg-3 col-md-3 d-flex justify-content-center">
            <a >
                <img class="image-responsive appImg" src="https://play-lh.googleusercontent.com/9iEJwOehasTxOIfEeQiTHHlzyzp_LKLklX6-z0j9hIzZv2K5p0G2Da_6lAanJiCTOa0=w720-h310-rw">
            </a>
        </div>
        <div class="col-lg-3 col-md-3 d-flex justify-content-center">
            <a>
                <img class="image-responsive appImg" src="https://play-lh.googleusercontent.com/2nhvFQ5T79nkkNeT4Jg7tMq3BdfA4mVojc85MJKWT2FGwiJL0GCMt7GeX39qfZc9WA=w720-h310-rw">
            </a>
        </div>
        <div class="col-lg-3 col-md-3 d-flex justify-content-center">
            <a>
                <img class="image-responsive appImg" src="https://play-lh.googleusercontent.com/09PK2ruQVlzCWZ98iHQwFpReGLOFM2BkfPButC8RWp2dMw1jzBly86e8jazbMHSgDw=w720-h310-rw">
            </a>
        </div>
        <div class="col-lg-3 col-md-3 d-flex justify-content-center">
            <a>
                <img class="image-responsive appImg" src="https://play-lh.googleusercontent.com/0IWDPV0T6EAVG_QSquiQrg4oEHrr4IP88u9i2bEWPs-icXbnFs3P0EZGtaFeSQDce3s=w720-h310-rw">
            </a>
        </div>
    </div>
    <div class="row mr-auto mb-3">
        <p>Super Phone Cleaner is an android mobile phone cache cleaner, speed booster and memory booster. Arming with CPU cooler, Phone cleaner can optimize the phone with the help of battery saver, super cleaner and power clean. Fast RAM cleaner, junk cleaner master and powerful app cache cleaner can improve your phone. RAM booster and junk notification cleaner also make their contribution in optimizing the phone. Phone Cleaner is all in one clean android master and phone booster toolbox.</p>
        <p>Phone Cleaner = Cache Cleaner + Speed Booster + Junk Cleaner + CPU Cooler + Battery Saver + Junk Notification Cleaner + RAM Cleaner + Space Cleaner + App Cleaner + Residual File Cleaner
            Install this super android cleaner, the all in one toolbox, Android Optimizer, and Android Master now to clean and boost your android phone. You won't ask how to clean my android phone any more.</p>
        <br>
    </div>
    <div class="row mr-auto mb-3">
