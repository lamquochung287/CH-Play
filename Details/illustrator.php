...
<head>
    <meta charset="UTF-8">
    <title>Adobe Illustrator Draw</title>
...
<div class="container" id="appContent">
    ...
    <div class="row mr-auto mb-3 d-flex justify-content-center">
        <iframe class="embed-responsive-item" width="854" height="480" src="https://www.youtube.com/embed/I44EodVzAG0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
    </div>
    <div class="row mb-5">
        <div class="col-lg-3 col-md-3 d-flex justify-content-center">
            <a >
                <img class="image-responsive appImg" src="https://play-lh.googleusercontent.com/f1pqt6raoRxVMvl2OWQ-Cz0LwtddBYnabT0NMPE-2cTJxE3HUzkQZ_hufapposnOQC0=w720-h310-rw">
            </a>
        </div>
        <div class="col-lg-3 col-md-3 d-flex justify-content-center">
            <a>
                <img class="image-responsive appImg" src="https://play-lh.googleusercontent.com/fxa0X19yBwYTW3mvBqqVjr1fsLZSKW1YIzzQef7OvG0Nszk07t25uIuEogulCJnPOHk=w720-h310-rw">
            </a>
        </div>
        <div class="col-lg-3 col-md-3 d-flex justify-content-center">
            <a>
        ...
        <div class="col-lg-3 col-md-3 d-flex justify-content-center">
            <a>
                <img class="image-responsive appImg" src="https://play-lh.googleusercontent.com/rnQIutCeqaeCMVK4GXtmMiEqn0asUK_IsH1ZcI4FVNkdV2R9VlKSURihpfFNdhjAAXZe=w720-h310-rw">
            </a>
        </div>
    ...
    <div class="row mr-auto mb-3">
        <p>Create vector artwork with image and drawing layers you can send to Adobe Illustrator or to Photoshop.</p>
        <p>Illustrators, graphic designers and artists can: <br>
            • Zoom up to 64x to apply finer details. <br>
            • Sketch with five different pen tips with adjustable opacity, size and color. <br>
            • Work with multiple image and drawing layers. <br>
            • Rename, duplicate, merge and adjust each individual layer. <br>
            • Insert basic shape stencils or new vector shapes from Capture. <br>
