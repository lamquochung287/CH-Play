...
<div class="container" id="appContent">
    <div class="row mr-0">
        ...
        <div class="col-lg-8 col-md-9 col- d-flex justify-content-center">
            <h2 class="title">
                Mercari
                <br>
                <p class="d-flex justify-content-end author">Mercari &nbsp&nbsp Shopping</p>

            </h2>
        </div>
    </div>
    <div class="row mr-auto mb-3 d-flex justify-content-center">
        <iframe class="embed-responsive-item" width="854" height="480" src="https://www.youtube.com/embed/Ide963zRb54" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
    </div>
    <div class="row mb-5">
        <div class="col-lg-3 col-md-3 d-flex justify-content-center">
            <a >
                <img class="image-responsive appImg" src="https://play-lh.googleusercontent.com/IViekfZg9L8oGX05-irYym7ekpdFeYc31-EburHXl9SssY4y-G4S_gAzddpw7wAWyA=w720-h310-rw">
            </a>
        </div>
        <div class="col-lg-3 col-md-3 d-flex justify-content-center">
            <a>
                <img class="image-responsive appImg" src="https://play-lh.googleusercontent.com/FVUGVzORA9mDxsy1cakEXkA7_fuPHPTSvls0kMI4NMaMDmOnGMG9RtTrac1zToUIBUA=w720-h310-rw">
            </a>
        </div>
        <div class="col-lg-3 col-md-3 d-flex justify-content-center">
            <a>
                <img class="image-responsive appImg" src="https://play-lh.googleusercontent.com/RWxAOAaQrZhyoSNKwylSSwCMoTzpgfXEQpIVXp-Zo8tTXbHOx-WSUUz6Zdpy-zek1Xo=w720-h310-rw">
            </a>
        </div>
        <div class="col-lg-3 col-md-3 d-flex justify-content-center">
            <a>
                <img class="image-responsive appImg" src="https://play-lh.googleusercontent.com/WJO6kFjWrJUotzu2i_o9ySxsiNwSN7q45qX4d3Y122zRBMNFuEouwrtxbh-mTyvcn_o=w720-h310-rw">
            </a>
        </div>
    ...
    <div class="row mr-auto mb-3">
        <b>Mercari is your marketplace.</b>
        <p>It’s the perfect place to go to declutter or find your new look. Letting go has never felt so good – it’s almost as good as finding your new favorite thing. And we’re here to help.</p>
        <p>Our team is always trying to find new ways to make exchanging items even easier. This means at-home pickups, same-day delivery, and a curated list of items you’ll love.</p>
        <p class="w-100">Say “goodbye” to the things you no longer love, and “hello” to the new you.</p>
        <b class="w-100">SELLING ON MERCARI:</b>
        <b class="w-100">It’s all from home.</b>
        <p>- Item sold? Contact your carrier for a home pickup. <br>
            - Check out Mercari Now in select cities. The day your item is sold, a driver will pick it up and deliver it to the buyer.</p>
        <b class="w-100">Listing is easy.</b>
        <p>- Take a few photos, add a description, and tap “list.” <br>
            - Listing an item will always be free. We only charge fees when your sale is complete. <br>
            - Once your ID is verified, you can get paid in minutes with Instant Pay.</p>
        <br>
    </div>
    <div class="row mr-auto mb-3">
