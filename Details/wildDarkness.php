    ...
    <div class="row mr-0">
        ...
        <div class="col-lg-8 col-md-9 col- d-flex justify-content-center">
            <h2 class="title">
                The Wild Darkness
                <br>
                <p class="d-flex justify-content-end author">PoPeyed Inc &nbsp&nbsp Action</p>

            </h2>
        </div>
    </div>
    <div class="row mr-auto mb-3 d-flex justify-content-center">
        <iframe class="embed-responsive-item" width="854" height="480" src="https://www.youtube.com/embed/VWlKwBGPr3I" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
    </div>
    <div class="row mb-3">
        <div class=" col-lg-6 col-md-12  col- d-flex justify-content-center">
            <a >
                <img class="image-responsive appImg" src="https://play-lh.googleusercontent.com/V_I0Cbzk7Wf9i3XxBJ9P7vE1xLxZzXrlp_ehWFgpOaxZl2rUXKADPbLvltkLJDEAVgo=w720-h310-rw">
            </a>
        </div>
        <div class=" col-lg-6 col-md-12 col- d-flex justify-content-center">
            <a>
                <img class="image-responsive appImg" src="https://play-lh.googleusercontent.com/wrRNqv1b692hxQguJSQDgow8LH8wJuqI7Uod-0g9L77vOE7cet2ZGmSdh_RHHxdCzQ=w720-h310-rw">
            </a>
        </div>

    </div>
    <div class="row mr-auto mb-3">
        <p>Inside a forest on a mysterious world... <br>
            A sorcerer is casting a spell in the dark. <br>
            Once the ritual was complete, a streak of light fell from the sky. <br> <br>

            Then you regain consciousness in the middle of a strange forest. <br>
            Where... Am I? Where is this place?!</p>
        <br>
    </div>
    <div class="row mr-auto mb-3">
