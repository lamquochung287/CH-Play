    ...
    <div class="row mr-0">
        ...
        <div class="col-lg-8 col-md-9 col- d-flex justify-content-center">
            <h2 class="title">
                Final Fantasy XV
                <br>
                <p class="d-flex justify-content-end author">Epic Action LLC &nbsp&nbsp Strategy</p>

            </h2>
        </div>
    </div>
    <div class="row mr-auto mb-3 d-flex justify-content-center">
        <iframe class="embed-responsive-item" width="854" height="480" src="https://www.youtube.com/embed/YISXbvzohO8" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
    </div>

    <div class="row mb-3">
        <div class=" col-lg-6 col-md-12 mb-2  col- d-flex justify-content-center">
            <a >
                <img class="image-responsive appImg" src="https://play-lh.googleusercontent.com/q_V9q6hqNzWFMKUtAfPFgFFuT7HfWmpxeZOjwl2JVBrPUOEx6v2CA-mvFMHXHQLt0lE=w720-h310-rw">
            </a>
        </div>
        <div class="col-lg-6 col-md-12 col- d-flex justify-content-center">
            <a>
                <img class="image-responsive appImg" src="https://play-lh.googleusercontent.com/mt--E4OqPi8EiKGDvqz3S2gf4IT6KA62zH-Hd_lZzCSXBChvaRQobmAa7AGCmQWH56Y=w720-h310-rw">
            </a>
        </div>

    </div>
    <div class="row mr-auto mb-3">
        <p>Alexis Ren is waiting for you! Join the adventure! Be the hero of your own Final Fantasy XV adventure in the brand new mobile strategy game Final Fantasy XV: A New Empire! Build your own kingdom, discover powerful magic, and dominate the realm alongside all of your friends!</p>
        <p>Final Fantasy XV: A New Empire is a mobile adventure that lets you rewrite a favorite classic to fulfill your unique destiny. Journey through vast kingdoms, gather magical resources, and build the strongest Empire in Final Fantasy history! Fight fire with magic to defend friends and defeat foes alongside millions of players from around the world! Do you have the strength and strategy to control the Crystal and rule the Realm?</p>
        <p>✔ Experience your very own epic FFXV adventure on your mobile phone <br>
            ✔ Jump into the action with Noctis, Cindy, and all of your favorite FF15 characters <br>
            ✔ Fight alongside friends and against foes in legendary battles against millions of players from around the world! <br>
            ✔ Build up your large army and best strategy to win in real-time action-packed battles <br>
            ✔ Create the ultimate Guild or join up with already-powerful forces <br>
            ✔ Strategize with your guild to crush enemies and beasts in real-time battles <br>
            ✔ Compete for the Crystal against players from all over the world <br>
            ✔ Travel the Realms and collect rare resources to build an epic Empire <br>
