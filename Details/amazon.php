...
<div class="container" id="appContent">
    <div class="row mr-0">
        ...
        <div class="col-lg-8 col-md-9 col- d-flex justify-content-center">
            <h2 class="title">
                Amazon Shipping
                <br>
                <p class="d-flex justify-content-end author">Amazon Mobile LLC &nbsp&nbsp Shopping</p>
    ...
    <div class="row mr-auto mb-3 d-flex justify-content-center">
        <div class="col-lg-8 col-md-10 col-sm-4 col-">
            <div class="embed-responsive embed-responsive-16by9">
                <iframe class="embed-responsive-item" width="854" height="480" src="https://www.youtube.com/embed/d-MHz0-c8fo" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>            </div>
        </div>
    ...
    <div class="row mb-5">
        ...
        <div class="col-lg-3 col-md-3 d-flex justify-content-center">
            <a >
                <img class="image-responsive appImg" src="https://play-lh.googleusercontent.com/x_j8jaFska7iB6ylOFoEHWd9L_cPfZw4hFV5b7cYwl-4GPe5H2-Ih0iEkGp8X6Q2CQ=w720-h310-rw">
            </a>
        </div>
        <div class="col-lg-3 col-md-3 d-flex justify-content-center">
            <a>
                <img class="image-responsive appImg" src="https://play-lh.googleusercontent.com/B6icTxOYNflKzLVw9iMpARu7ACHGyUr9ny-AkWDY9j3fTYESoqjxCgF-ggYthabPvs0=w720-h310-rw">
            </a>
        </div>
        <div class="col-lg-3 col-md-3 d-flex justify-content-center">
            <a>
                <img class="image-responsive appImg" src="https://play-lh.googleusercontent.com/V55BSCxHBCInqcSpwLDbNas5kthVMkoI_KWV2y165vtD3cLwVEKATZILgz6ezVwBHRk=w720-h310-rw">
            </a>
        </div>
    ...
    <div class="row mr-auto mb-3">
        <b><p>Search, Find, Ship, and Save</p></b>
        <p>The Amazon Shopping app lets you shop millions of products and manage your Amazon orders from anywhere. Browse, shop by department, compare prices, read reviews, share products with friends, and check the status of your orders.</p>
        <p>Compare prices and availability by typing in your search, scanning a barcode or an image with your camera, or using your voice. Never miss a deal with easy access to Lightning Deals and the Deal of the Day. You can also sign-up for shipment notifications to know when your order ships and arrives. You have full access to your Shopping Cart, Wish Lists, payment and Prime shipping options, Subscribe & Save order history, and 1-Click settings, just like on the full Amazon.com site. All Amazon Shopping app purchases are routed through Amazon's secure servers to encrypt and safeguard your personal information.</p>
        <br>
    </div>
    <div class="row mr-auto mb-3">
